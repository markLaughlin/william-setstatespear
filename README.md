...
This is a sample project used for education of React Router. It is a good example of how to use routes and shows how to replace anchors with rotes for improved efficiency. It also demonstrates how to use dynamic routes. 
